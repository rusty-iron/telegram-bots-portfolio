...
#### Начало работы
![Приветствие](./screenshots/01_start.jpg)

*Команда /start запускает процесс сбора заявки*

#### Сбор данных

**Шаг 1/4: Ввод имени**

![Ввод имени](./screenshots/02_step1_name.jpg)

**Шаг 2/4: Номер телефона**

![Номер телефона](./screenshots/03_step2_phone.jpg)

*Валидация формата телефона в режиме реального времени*

#### Подтверждение

![Подтверждение данных](./screenshots/04_confirmation.jpg)

*Пользователь видит все введенные данные перед отправкой*

#### Завершение

![Успешная отправка](./screenshots/05_success.jpg)

*Подтверждение успешной отправки заявки*
...
![Новая заявка](./screenshots/06_new_lead.jpg)

*Администратор получает мгновенное уведомление*

#### Главное меню админа

![Меню админки](./screenshots/07_admin_menu.jpg)

*Управление всеми заявками из одного меню*

#### Просмотр заявок

![Просмотр заявки](./screenshots/08_lead_menu.jpg)

*Детальный просмотр карточки заявки*

#### Работа с заявкой

**Ответ клиенту**

![Ответ клиенту](./screenshots/09_lead_answer.jpg)

*Прямое общение с клиентом из админ-панели*

![Ответ отправлен](./screenshots/10_answer_sent.jpg)

*Подтверждение отправки сообщения*

**Изменение статуса**

![Смена статуса](./screenshots/11_lead_status_change.jpg)

*Отслеживание работы с заявкой*

#### Клиент получает ответ

![Ответ получен](./screenshots/12_answer_received.jpg)

*Клиент видит ответ от поддержки*
